// ============================================================
//  35MM EMULATOR v2 — PRESET 1: "SUTIL"
...
//!HOOK MAIN
//!BIND HOOKED
//!DESC 35mm-1 gate weave

#define WEAVE_X  0.00022   // deriva horizontal (fraccion de la altura)
#define WEAVE_Y  0.00030   // deriva vertical
#define JITTER   0.00008   // temblor por fotograma
#define FLICKER  0.0025    // parpadeo de brillo del proyector
...
//!HOOK MAIN
//!BIND HOOKED
//!DESC 35mm-1 grade (contraste/saturacion/vineta)

#define CONTRAST 0.10
#define SATUR    1.06
#define WARMTH   0.020
#define FADE     0.0
#define VIGNETTE 0.07
#define HALATION 0.0
#define HAL_THR  0.75
...
//!HOOK OUTPUT
//!BIND HOOKED
//!DESC 35mm-1 grano organico v2

#define GRAIN       0.030   // intensidad del grano
#define GRAIN_SIZE  1.6     // tamano del grano en px (a 4K)
#define CHROMA_GR   0.18    // decorrelacion de color del grano
#define DUST_PROB   0.0     // probabilidad de mota de polvo por fotograma
#define HAIR_PROB   0.0     // fraccion de motas que son pelusas alargadas
#define CUE_PERIOD  0.0     // sin quemaduras (0 = off; en segundos)
