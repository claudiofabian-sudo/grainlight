// ============================================================
//  35MM EMULATOR v2 — PRESET 2: "CINE 2000s"
//  La experiencia de multicine de los 2000s: grano visible,
//  gate weave claro, print con contraste y color, halation en
//  altas luces y motas de polvo ocasionales.
//
...
//!HOOK MAIN
//!BIND HOOKED
//!DESC 35mm-2 gate weave

#define WEAVE_X  0.00042   // deriva horizontal (fraccion de la altura)
#define WEAVE_Y  0.00058   // deriva vertical
#define JITTER   0.00016   // temblor por fotograma
#define FLICKER  0.0018    // parpadeo de brillo del proyector
...
//!HOOK MAIN
//!BIND HOOKED
//!DESC 35mm-2 grade (contraste/saturacion/vineta)
...
//!HOOK OUTPUT
//!BIND HOOKED
//!DESC 35mm-2 grano organico v2

#define GRAIN       0.052   // intensidad del grano
#define GRAIN_SIZE  2.2     // tamano del grano en px (a 4K)
#define CHROMA_GR   0.24    // decorrelacion de color del grano
#define DUST_PROB   0.05    // probabilidad de mota de polvo por fotograma
#define HAIR_PROB   0.25    // fraccion de motas que son pelusas alargadas
#define CUE_PERIOD  900.0   // quemadura cada 15 min (segundos; 0 = off)
