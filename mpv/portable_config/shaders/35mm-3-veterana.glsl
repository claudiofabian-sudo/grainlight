// ============================================================
//  35MM EMULATOR v2 — PRESET 3: "COPIA VETERANA"
//  Una copia con cientos de proyecciones encima: grano grueso,
//  weave y parpadeo marcados, negros levemente lavados, polvo
//  y pelusas frecuentes. (Sin rayas verticales.)
//
...
//!HOOK MAIN
//!BIND HOOKED
//!DESC 35mm-3 grade (contraste/saturacion/vineta)
